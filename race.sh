...
usage() {
  ...
  printf "\t# calculate the average pace to run 10km in 40 minutes\n"
  printf "\trace 10 40:00\t\n"
  printf "\t>>> Average Pace: ${GREEN}4:00${NC}\n"
  printf "\n"
  printf "\t# calculate the final time for 10 km at 4:00/km\n"
  printf "\trace 10 -t 4:00\t\n"
  printf "\t>>> Final Time: ${GREEN}40:00${NC}\n"
  printf "\n"
  printf "\t# add two times together\n"
  printf "\trace -c 40:45 5:25\t\n"
  printf "\t>>> 46:10\n"
}
